...
<!--
        <div class="container-fluid">
            <div class="nav navbar-nav">
                ...
                <a href="index.php"><!--<img src="Img/MNNITTweets.png" width="200.8px" height="80px">>MNNIT Twitter</a>
...
-->
        <div class="container-fluid" style="background-color: #f5f0f2;margin-top:80px;">
                ...
                <form method="post">
                    <div class="col-md-6 col-xs-12 signInTab">
                        ...
                        <center>
                            ...
                            <br><br>
                            <p style="font-size:16px;">New to MNNIT Twiter? Sign Up Here.. <span class="glyphicon glyphicon-arrow-right"></span></p>
                        </center>
                </div>
                        </div>
                    </div>
            ...
            <div class="container-fluid aboutDiv" id="about">
                <div class="row">
                    ...
                    <div class="col-md-8 col-xs-10" style="padding-left:30px;">
                        ...
                        <p class="aboutInfo"><span class="glyphicon glyphicon-envelope"></span> <b>Mail Us:</b><br> <a href="mailto:abhishekadhar03@gmail.com">abhishekadhar03@gmail.com</a></p>
                        <p class="aboutInfo"><span class="glyphicon glyphicon-phone"></span> <b>Contact Us:</b><br> 8177051447</p>

                        <p class="aboutInfo"><i class="fa fa-facebook-square"></i> <b>Follow Us:</b><br> <a href="#w">Facebook.com/MNNIT_Twiter</a></p>
                        <br>
                        <p class="aboutInfo"><b>MNNIT Twitter</b></p>
                    </div>
                </div>
            </div>
        </footer>
